...
partial class Form1
{
    ...
    private void InitializeComponent()
    {
        ...
        tabcMain.Size = new Size(1175, 632);
        tabcMain.TabIndex = 0;
        // 
        // tabPage1
        // 
        ...
        tabPage1.Size = new Size(1167, 604);
        tabPage1.TabIndex = 0;
        ...
        cmbSpeed.Location = new Point(455, 36);
        ...
        // btnThrottleGraph
        // 
        btnThrottleGraph.Location = new Point(1028, 391);
        btnThrottleGraph.Margin = new Padding(2);
        btnThrottleGraph.Name = "btnThrottleGraph";
        btnThrottleGraph.Size = new Size(101, 34);
        ...
        // btnAngleGraph
        // 
        btnAngleGraph.Location = new Point(1028, 353);
        btnAngleGraph.Margin = new Padding(2);
        btnAngleGraph.Name = "btnAngleGraph";
        btnAngleGraph.Size = new Size(101, 34);
        ...
        // pic_Graph
        // 
        pic_Graph.Location = new Point(26, 438);
        pic_Graph.Margin = new Padding(2);
        pic_Graph.Name = "pic_Graph";
        pic_Graph.Size = new Size(1103, 156);
        ...
        lbl_ThrottleV.Location = new Point(958, 397);
        ...
        lbl_Throttle.Location = new Point(887, 397);
        lbl_Throttle.Margin = new Padding(2, 0, 2, 0);
        lbl_Throttle.Name = "lbl_Throttle";
        lbl_Throttle.Size = new Size(76, 28);
        ...
        lbl_AngleV.Location = new Point(805, 397);
        ...
        lbl_Angle.Location = new Point(754, 397);
        lbl_Angle.Margin = new Padding(2, 0, 2, 0);
        lbl_Angle.Name = "lbl_Angle";
        lbl_Angle.Size = new Size(56, 28);
        ...
        lbl_FrameV.Location = new Point(678, 397);
        ...
        lbl_Frame.Location = new Point(604, 397);
        ...
        list_FileCheck.Location = new Point(618, 67);
        list_FileCheck.Margin = new Padding(2);
        list_FileCheck.Name = "list_FileCheck";
        list_FileCheck.Size = new Size(294, 94);
        list_FileCheck.TabIndex = 13;
        // 
        // tbar_Dk
        // 
        tbar_Dk.Location = new Point(26, 380);
        tbar_Dk.Margin = new Padding(2);
        tbar_Dk.Name = "tbar_Dk";
        tbar_Dk.Size = new Size(545, 45);
        tbar_Dk.TabIndex = 12;
        tbar_Dk.Scroll += tbar_Dk_Scroll;
        // 
        // btn_Retry
        // 
        btn_Retry.Location = new Point(1011, 67);
        ...
        // btn_Find
        // 
        btn_Find.Location = new Point(618, 174);
        ...
        // btn_Del
        // 
        btn_Del.Location = new Point(932, 67);
        ...
        // btn_SmallR
        // 
        btn_SmallR.Location = new Point(368, 342);
        ...
        // btn_Stop
        // 
        btn_Stop.Location = new Point(239, 344);
        ...
        // btn_SmallL
        // 
        btn_SmallL.Location = new Point(113, 344);
        ...
        // btn_BigL
        // 
        btn_BigL.Location = new Point(26, 67);
        btn_BigL.Margin = new Padding(2);
        btn_BigL.Name = "btn_BigL";
        btn_BigL.Size = new Size(73, 309);
        btn_BigL.TabIndex = 5;
        btn_BigL.Text = "<";
        ...
        // btn_BigR
        // 
        btn_BigR.Location = new Point(500, 67);
        btn_BigR.Margin = new Padding(2);
        btn_BigR.Name = "btn_BigR";
        btn_BigR.Size = new Size(71, 309);
        btn_BigR.TabIndex = 4;
        btn_BigR.Text = ">";
        ...
        // pic_DkScreen
        // 
        pic_DkScreen.BackColor = Color.Black;
        pic_DkScreen.BorderStyle = BorderStyle.FixedSingle;
        pic_DkScreen.Location = new Point(113, 67);
        pic_DkScreen.Margin = new Padding(2);
        pic_DkScreen.Name = "pic_DkScreen";
        pic_DkScreen.Size = new Size(374, 271);
        pic_DkScreen.TabIndex = 2;
        pic_DkScreen.TabStop = false;
        // 
        // btnLoadImages
        // 
        btnLoadImages.Location = new Point(153, 20);
        ...
        // btnLoadCatalog
        // 
        btnLoadCatalog.Location = new Point(26, 20);
        ...
        tabp_Serve.Size = new Size(1167, 604);
        ...
        lblStatus.Location = new Point(504, 51);
        ...
        lblConda.Location = new Point(105, 51);
        ...
        txtCondaEnv.Location = new Point(275, 51);
        ...
        txtLog.Location = new Point(100, 95);
        txtLog.Margin = new Padding(2);
        txtLog.Multiline = true;
        txtLog.Name = "txtLog";
        txtLog.ScrollBars = ScrollBars.Vertical;
        txtLog.Size = new Size(950, 499);
        txtLog.TabIndex = 1;
        ...
        btnTrain.Location = new Point(834, 39);
