...
partial class Form1
{
    ...
    private void InitializeComponent()
    {
        ...
        lbl_ImageRoute.Location = new Point(1301, 12);
        ...
        lbl_CatalogRoute.Location = new Point(1112, 12);
        ...
        btnLoadPilot.Location = new Point(746, 34);
        ...
        btn_Restore.Location = new Point(1363, 643);
        btn_Restore.Margin = new Padding(3, 2, 3, 2);
        btn_Restore.Name = "btn_Restore";
        btn_Restore.Size = new Size(92, 52);
        ...
        chk_Throttle.Location = new Point(166, 573);
        ...
        chk_Angle.Location = new Point(49, 573);
        ...
        myTrackbar1.Location = new Point(41, 501);
        ...
        tab_Trash.Location = new Point(875, 90);
        tab_Trash.Margin = new Padding(3, 2, 3, 2);
        tab_Trash.Name = "tab_Trash";
        tab_Trash.SelectedIndex = 0;
        tab_Trash.Size = new Size(583, 463);
        ...
        tabPage2.Size = new Size(575, 430);
        tabPage2.TabIndex = 0;
        tabPage2.Text = "파일 목록";
        ...
        tabPage3.Size = new Size(575, 430);
        tabPage3.TabIndex = 1;
        tabPage3.Text = "복구";
        ...
        list_DeletedCheck.Margin = new Padding(3, 2, 3, 2);
        ...
        txtTrainLoss.Location = new Point(1227, 561);
        ...
        txtTrainLoss.Size = new Size(271, 150);
        ...
        label2.Location = new Point(1079, 598);
        label2.Name = "label2";
        ...
        label1.Location = new Point(1079, 564);
        label1.Name = "label1";
        ...
        picTrainGraph.Location = new Point(131, 561);
