...
partial class Form1
{
    ...
    private void InitializeComponent()
    {
        ...
        Carrotpic.Location = new Point(1021, 462);
        Carrotpic.Margin = new Padding(2);
        Carrotpic.Name = "Carrotpic";
        Carrotpic.Size = new Size(135, 115);
        ...
        label4.Location = new Point(300, 42);
        ...
        label3.Location = new Point(300, 29);
        ...
        btnLoadPilot.Location = new Point(538, 33);
        btnLoadPilot.Margin = new Padding(2);
        btnLoadPilot.Name = "btnLoadPilot";
        btnLoadPilot.Size = new Size(104, 24);
        ...
        btn_Restore.Location = new Point(940, 535);
        ...
        lbl_To2.Location = new Point(872, 494);
        lbl_To2.Margin = new Padding(2, 0, 2, 0);
        ...
        lbl_To.Location = new Point(872, 474);
        lbl_To.Margin = new Padding(2, 0, 2, 0);
        lbl_To.Name = "lbl_To";
        ...
        lblThrottle.Location = new Point(702, 499);
        ...
        lblAngle.Location = new Point(698, 472);
        ...
        txtThrottleF2.Location = new Point(902, 499);
        txtThrottleF2.Margin = new Padding(2);
        ...
        txtAngleF2.Location = new Point(902, 472);
        txtAngleF2.Margin = new Padding(2);
        ...
        btn_Find.Location = new Point(687, 534);
        ...
        pic_Graph.Location = new Point(32, 458);
        ...
        txtThrottleF.Location = new Point(770, 499);
        txtThrottleF.Margin = new Padding(2);
        txtThrottleF.Name = "txtThrottleF";
        txtThrottleF.Size = new Size(95, 23);
        ...
        txtAngleF.Location = new Point(770, 472);
        txtAngleF.Margin = new Padding(2);
        txtAngleF.Name = "txtAngleF";
        txtAngleF.Size = new Size(95, 23);
        ...
        myTrackbar1.Location = new Point(32, 393);
        ...
        cmbSpeed.Location = new Point(418, 33);
        ...
        lbl_ThrottleV.Location = new Point(571, 424);
        ...
        lbl_Throttle.Location = new Point(520, 424);
        ...
        lbl_AngleV.Location = new Point(446, 424);
        ...
        lbl_Angle.Location = new Point(376, 424);
        ...
        lbl_FrameV.Location = new Point(300, 424);
        ...
        lbl_Frame.Location = new Point(225, 424);
        ...
        btn_Retry.Location = new Point(770, 534);
        ...
        btn_Del.Location = new Point(858, 535);
        ...
        btn_SmallR.Location = new Point(418, 352);
        btn_SmallR.Margin = new Padding(2);
        btn_SmallR.Name = "btn_SmallR";
        btn_SmallR.Size = new Size(160, 34);
        ...
        btn_Stop.Location = new Point(262, 352);
        btn_Stop.Margin = new Padding(2);
        btn_Stop.Name = "btn_Stop";
        btn_Stop.Size = new Size(152, 34);
        btn_Stop.TabIndex = 7;
        btn_Stop.Text = "stop";
        ...
        btn_SmallL.Location = new Point(98, 352);
        btn_SmallL.Margin = new Padding(2);
        btn_SmallL.Name = "btn_SmallL";
        btn_SmallL.Size = new Size(160, 34);
        ...
        btn_BigL.Location = new Point(32, 67);
        btn_BigL.Margin = new Padding(2);
        btn_BigL.Name = "btn_BigL";
        btn_BigL.Size = new Size(62, 319);
        btn_BigL.TabIndex = 5;
        btn_BigL.Text = "<";
        ...
        btn_BigR.Location = new Point(580, 67);
        btn_BigR.Margin = new Padding(2);
        btn_BigR.Name = "btn_BigR";
        btn_BigR.Size = new Size(62, 319);
        btn_BigR.TabIndex = 4;
        btn_BigR.Text = ">";
        ...
        pic_DkScreen.Location = new Point(98, 67);
        pic_DkScreen.Margin = new Padding(2);
        pic_DkScreen.Name = "pic_DkScreen";
        pic_DkScreen.Size = new Size(480, 281);
        ...
        tabPage2.Size = new Size(465, 369);
        tabPage2.TabIndex = 0;
        tabPage2.Text = "파일 목록";
        ...
        tabPage3.Size = new Size(465, 369);
        tabPage3.TabIndex = 1;
        tabPage3.Text = "복구";
        ...
        list_DeletedCheck.Size = new Size(465, 364);
        ...
        btnStopTrain.Location = new Point(813, 40);
        ...
        lblStatus.Location = new Point(523, 60);
        ...
        lblConda.Margin = new Padding(2, 0, 2, 0);
        ...
        txtCondaEnv.Location = new Point(310, 61);
        ...
        btnTrain.Location = new Point(938, 40);
